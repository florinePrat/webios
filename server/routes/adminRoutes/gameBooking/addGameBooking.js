...
module.exports = async (req, res) => {
    try{
        ...
        let gameID = req.body.gameIdSelected;
        ...
        await ExhibitorController.addGame(gameID, req.body.exhibitorId);
        ...
        const gameBooking = await GameBookingController.createBookingGame(
            gameID,req.body.festivalId,req.body.exhibitorId,req.body.bookingId,req.body.zoneId,req.body.qtExhib,req.body.qtSend,
            req.body.tombola,req.body.dotation,Date.now(),req.body.comment,req.body.putOnPlan,req.body.bringByExhibitor,
            false,false,0,false);
        // 2 - change suivi

        // @TODO : //////////////// ATTENTION !!!! SI LE STATUSTRACKING EST SUP2RIEUR A LISTE DE JEUX DMAND2E (LISTE D JEUX RECU...) IL VA Y REVENIR....DONC IL faut faire une vérif à ce niveau là !
        ...
        await ZoneController.addGameZone(gameID,req.body.zoneId);
